...
/**
 * Validate a Person using the default scema
 * @param value: the value that represent a preson to validate
 * @param options
 * @param next
 */
exports.validatePerson = (value, options, next) => {
...
/**
 * Validate a date using the default schema
 * @param value
 * @param options
 * @param next
 */
exports.validateDate = (value, options, next) => {

    Joi.validate(value, dateSchema, (err, val) => {
...
/**
 * Validate a place using the default schema
 * @param value
 * @param options
 * @param next
 */
exports.validatePlace = (value, options, next) =>  {

    Joi.validate(value, placeSchema, (err, val) => {
